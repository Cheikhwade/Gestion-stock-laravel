...
<nav class="navbar navbar-dark bg-dark">
    ...
    <span class="navbar-brand mb-0 h1">Fast-food</span>
</nav>
...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="list-group-item list-group-item-action active">Bilan</div>
        <div>
            <label>Total</label>
